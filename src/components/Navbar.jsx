    ...
    <div className="container px-4 mx-auto relative text-sm">
        <div className="flex justify-between items-center">
            ...
            <div className="hidden lg:flex space-x-12 justify-center items-center">
                <button className='border rounded-md px-3 py-2 bg-transparent'>Sign in</button>
                <button className='border rounded-md px-6 py-2 bg-gradient-to-r from-orange-600 to-orange-900'>Create an account</button>
            </div>
...
<div className="lg:hidden md:flex flex-col justify-end" >
    ...
    <div className="lg:hidden z-20 flex flex-col items-center bg-neutral-900 justify-center w-full fixed right-0 p-12 ">
        ...
        <div className="flex space-x-6 mt-4">
            <button className='border rounded-md px-3 py-2 bg-transparent'>Sign in</button>
            <button className='border rounded-md px-4 py-2 bg-gradient-to-r from-orange-500 to-orange-800'>Create an account</button>
        </div>
    </div>
    ) 
    } 
